...
//                {
//                    Debug.DrawLine(worldPoint, Vector3.up);
...
//    void instantiateSphere(Node node)
//    {
        
//        GameObject obj = Instantiate(spherePrefab, node.worldPosition, Quaternion.identity);
//        obj.transform.localScale *= nodeRadius;
//        if (node.walkable)
